...
void testuoti(const vector<string>& failai, const vector<int>& irasu_skaicius, 
              int skaiciavimo_metodas, const string& konteinerio_tipas) {
    ...
    for (size_t i = 0; i < failai.size(); i++) {
        ...
        // SKAIČIAVIMAS - skaiciuoti_rezultatus()
        ...
        // STUDENTŲ PADALINIMAS Į GRUPES - padalinti_i_grupes()
